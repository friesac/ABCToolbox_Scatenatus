...
#PBS -l nodes=1:ppn=1
#PBS -N ABC_SSSP_Model1_2016-03-09-13-04
#PBS -l mem=4gb
#PBS -m a
...
mv /nfs/12/osu0378/Scate_msat/population_results/SSSP_Model1_2016-03-09-13-04/Model1_calibration.input $TMPDIR
mv /nfs/12/osu0378/Scate_msat/population_results/SSSP_Model1_2016-03-09-13-04/Model1.par $TMPDIR
mv /nfs/12/osu0378/Scate_msat/population_results/SSSP_Model1_2016-03-09-13-04/Model1.est $TMPDIR 
cd $TMPDIR
...
rm ABCsampler
rm arlsumstat
cp -R * /nfs/12/osu0378/Scate_msat/population_results/SSSP_Model1_2016-03-09-13-04
cd /nfs/12/osu0378/Scate_msat/population_results/SSSP_Model1_2016-03-09-13-04
